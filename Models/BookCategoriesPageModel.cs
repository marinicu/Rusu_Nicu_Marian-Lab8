...
namespace Rusu_Nicu_Marian_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Rusu_Nicu_Marian_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Rusu_Nicu_Marian_Lab8Context context,
